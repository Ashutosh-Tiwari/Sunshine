package com.example.ashutoshtiwari.sunshine.sync;
...
import com.example.ashutoshtiwari.sunshine.BuildConfig;
import com.example.ashutoshtiwari.sunshine.ForecastActivity;
import com.example.ashutoshtiwari.sunshine.R;
import com.example.ashutoshtiwari.sunshine.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static final int SYNC_INTERVAL = 60180;
        ...
        if (displayNotifications) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    //Create an explicit intent to decide what the notification should open when clicked
                    Intent intent = new Intent(context, ForecastActivity.class);
                    //Create an artificial back stack to ensure that navigating backward from the activity
                    //leads out of the app to the home screen
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
...

        {
            ...
            //One can put a log here to see the URL
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        // All temperatures are children of the "custom_ripple_with_drawable" object.
        final String OWM_TEMPERATURE = "custom_ripple_with_drawable";
        ...
        try {
            ...
            for (int i = 0; i < weatherArray.length(); i++) {
                ...
                // Temperatures are in a child object called "custom_ripple_with_drawable".  Try not to name variables
                // "custom_ripple_with_drawable" when working with temperature.  It confuses everybody.
            ...
            if (cVVector.size() > 0) {
                ...
                Log.v(LOG_TAG, "DATA: " + cvArray[1]);
            }
            Log.v(LOG_TAG, "Service Complete. " + inserted + " Inserted");
